              ...
              <div className="w-full max-w-md bg-[#1a1a2e] rounded-2xl p-8 shadow-2xl border border-white/10">
                ...
                {tab === 'login' ? (
                    <form onSubmit={handleLogin} className="space-y-5">
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1">メールアドレス</label>label>
                                ...
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1">パスワード</label>label>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1">お名前</label>label>
                                ...
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1">パスワード（8文字以上）</label>label>
                                              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={8}
                                                                className="w-full bg-[#0f0f1a] border border-white/20 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-violet-500" />
                                </div>div>
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1">パスワード確認</label>label>
                                              <input type="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} required
                                                                className="w-full bg-[#0f0f1a] border border-white/20 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-violet-500" />
                                </div>div>
                                <div>
                                              <label className="block text-sm text-gray-400 mb-1">招待コード（任意）</label>label>
                      ...
                      <div className="flex items-center my-6">
                                ...
                                <span className="px-4 text-sm text-gray-500">または</span>span>
                                <div className="flex-1 border-t border-white/10" />
                      </div>div>
